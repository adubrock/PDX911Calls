...
describe CallsController do
  ...
  let(:valid_attributes) { { "call_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved call as @call" do
        ...
        post :create, {:call => { "call_id" => "invalid value" }}, valid_session
        assigns(:call).should be_a_new(Call)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested call" do
        ...
        Call.any_instance.should_receive(:update).with({ "call_id" => "MyString" })
        put :update, {:id => call.to_param, :call => { "call_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the call as @call" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Call.any_instance.stub(:save).and_return(false)
        put :update, {:id => call.to_param, :call => { "call_id" => "invalid value" }}, valid_session
        assigns(:call).should eq(call)
      end
